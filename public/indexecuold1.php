...
<html lang="en">
<head>
<title> ECU Consignment Website </title>
<meta charset="utf-8">
  ...
  <div id ="container" >
	...
	<img src="images/keychainthumb.jpg" width="100" height="100" alt="ECU Key Chain">
		...
		<main role="main" id="content">
			...
			<a href="images/thumbtshirt.jpg" > ECU Sweater<figure><img src="images/thumbtshirt1.jpg" alt="Grey hooded sweater" width="150" height="150">
			<figcaption>View Larger<br>
			</figcaption>
			</figure>
			</a>
			</li>	
			...
			<li>
			<a href="images/textbook.jpg" > Physics Textbook<figure><img src="images/textbookthumb.jpg" alt="Physics Textbook" width="150" height="150">
			<figcaption>View Larger<br>
			</figcaption>
			</figure>
			</a>
			...
			<li>
			<a href="images/basebalhat.jpg" > Baseball Hat<figure><img src="images/basebalhatthumb.jpg" alt="ECU Baseball Hat" width="150" height="150">
			<figcaption>View Larger<br>
			</figcaption>
			</figure>
			</a>
